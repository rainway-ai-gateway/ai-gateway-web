...
登录成功后进入控制台，整体布局为「左侧导航 + 右侧内容区」。首次使用建议先浏览本章，再跟做 [13 场景实战](13-scenarios.md)。
...
- 首次配置请跟做 [13 场景实战](13-scenarios.md)；
- 字段级说明见各模块章节：[模型服务商](03-model-provider.md)、[业务集群](04-ai-business-cluster.md)、[EPP 调度](05-epp-schedule.md)、[模型定价](06-model-prices.md)、[Entity 组织](08-entity.md)、[API Key](09-api-key.md)、[路由管理](10-route.md)、[操作日志](11-operation-logs.md)、[数据报表](12-report.md)。
