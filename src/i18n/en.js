...
export default {
  ...
  route: {
    ...
    loadFailed: 'Failed to load route rules',
    ...
    ruleNameLengthError: 'Rule name must be 1-64 characters long',
    ruleNameFormatError:
      'Rule name may only contain letters, digits, -, _, . and must not start or end with -, _, .',
  ...
  entity: {
    ...
    entityDescriptionPlaceholder: 'Please enter Entity description',
    descriptionLengthError: 'Entity description cannot exceed 255 characters',
    descriptionControlCharsError: 'Entity description cannot contain control characters',
  ...
  provider: {
    ...
    protocolPathHelp: 'Configure the upstream API base path per protocol; BFE rewrites matching standard endpoints to this base path (OpenAI-compatible clients with or without /v1). Unconfigured protocols pass through unchanged; clearing all mappings submits an empty object to disable rewriting.',
    protocolPathProto: 'Protocol',
    protocolPathPrefix: 'Upstream API Base Path',
    protocolPathValuePlaceholder: 'e.g. /v1',
    protocolPathEmpty:
      'No protocol path mapping configured (request paths are forwarded as-is on save)',
    protocolPathAdd: '+ Add Mapping',
    protocolPathProtoInvalid: 'Protocol "{proto}" is not in model protocols',
    protocolPathPrefixInvalid: 'Upstream API base path must start with /',
    protocolPathPrefixTrailingSlash: 'Upstream API base path must not end with /',
    protocolPathPrefixInvalidChars: 'Upstream API base path contains invalid characters (? $ # ..)',
  ...
  report: {
    ...
    query: 'Query',
    timeRangeInvalid: 'Invalid time range, please re-select',
    timeRangeExceeded: 'The query window cannot exceed 7 days',
    overview: 'Overview',
    logs: 'Logs',
